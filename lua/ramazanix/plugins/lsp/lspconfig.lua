  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "gR", "<cmd>Telescope lsp_references<CR>", opts) -- show defenition, references
        ...
        keymap.set("n", "gt", "<cmd>Telescope lsp_implementations<CR>", opts) -- show lsp implementations
    ...
    local signs = { Error = "☠️", Warn = "🪤", Hint = "🧻️", Info = "📖"}
